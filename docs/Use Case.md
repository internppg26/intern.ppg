markdown_content = """# Use Case Specifications: Sistem Manajemen Pembelajaran (LMS)
...
crud_entities = ["Program", "Modul", "Ujian", "Artikel", "Galeri", "File"]
for entity in crud_entities:
    markdown_content += f"""### Use Case: Mengelola {entity}
| Komponen | Deskripsi |
| :--- | :--- |
| **Objective** | Admin dapat menambah, mengubah, dan menghapus {entity}. |
| **Actors** | Admin |
| **Pre-condition** | Admin login dan masuk ke menu Kelola {entity}. |
...
| **Post-condition** | Data {entity} pada sistem berhasil diperbarui. |

"""

markdown_content += """## 5. Kelompok Pengunjung Publik
...
file_path = "/mnt/data/use_case_specifications.md"
