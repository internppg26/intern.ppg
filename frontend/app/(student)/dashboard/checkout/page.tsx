          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="bg-white border border-neutral-200 rounded-3xl p-8 shadow-sm">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div>
                  <span className="bg-[#F4E3D7] text-[#964B13] text-[10px] font-bold px-3 py-1 rounded uppercase tracking-widest mb-3 inline-block">PREMIUM COURSE</span>
                  <h3 className="text-2xl font-black text-[#0B2545] leading-tight mb-2">Corporate Strategy Masterclass</h3>
                  <div className="flex items-center gap-2 text-sm text-neutral-600 mb-4">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                    Dr. Jane Smith
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-2xl font-black text-[#0B2545]">Rp 4.999.000</span>
                    <span className="text-sm font-medium text-neutral-400 line-through">Rp 7.500.000</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-[350px]">
            ...
            <div className="bg-white border border-neutral-200 shadow-xl rounded-3xl p-8 mb-6">
              ...
              <div className="flex justify-between items-center text-sm mb-6 pb-6 border-b border-neutral-200">
                ...
                <span className="text-[#0B2545] font-bold">Rp 4.999.000</span>
              </div>
              ...
              <Link href="/dashboard/payment" className="block w-full bg-[#B55D1A] hover:bg-[#964B13] text-white text-center py-4 rounded-xl font-bold text-sm tracking-wider flex items-center justify-center gap-2 transition-colors shadow-lg shadow-[#B55D1A]/30">
