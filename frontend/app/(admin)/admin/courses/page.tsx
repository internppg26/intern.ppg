  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#F9FAFC] relative">
      ...
      <div className="flex-1 overflow-y-auto p-8 lg:px-12 font-sans">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-8 sm:mb-12 relative">
          <div className="flex-1 text-center sm:text-left">
            <h2 className="text-3xl sm:text-4xl font-black text-[#0B2545] tracking-tight">Program</h2>
          </div>
          <button 
