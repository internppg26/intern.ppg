      ...
      <div className="flex-1 overflow-y-auto p-8 lg:px-12 font-sans pb-16">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-6 mb-12 mt-4 sm:mt-8 relative">
          <div className="flex-1 text-center sm:text-left">
            <h2 className="text-3xl sm:text-4xl font-black text-[#0B2545] tracking-tight leading-tight px-0 sm:px-12">
              Daftar Course Bidang<br className="hidden sm:block" /> {bidangName}
            </h2>
          </div>
          <button 
